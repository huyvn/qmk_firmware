...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LALT(S(KC_TAB)), LALT(KC_TAB), KC_LCTL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J , KC_K, KC_L,  KC_SCLN, KC_QUOT   , KC_ENTER, KC_ENTER,       KC_HOME, \
    LCTL(S(KC_TAB)), LCTL(KC_TAB), KC_LSPO , KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N , KC_M   , KC_COMM, KC_DOT , KC_SLSH   , KC_RSPC , KC_UP ,       KC_END, \
    LGUI(KC_L), LCTL(LALT(KC_DEL)), TT(1),KC_LGUI,KC_LALT, KC_SPC,CTL_T(KC_SPC),SFT_T(KC_SPC), KC_RALT,TT(2),RCTL_T(KC_ESC),KC_LEFT,KC_DOWN,KC_RIGHT \
    ),
    [1] = KEYMAP(
