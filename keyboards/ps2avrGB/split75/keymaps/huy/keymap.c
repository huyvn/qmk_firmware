...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    LCTL(KC_C), LCTL(KC_X),         KC_GRAVE, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7 , KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, KC_BSPC , KC_BSPC        , KC_HOME, \
    LCTL(KC_V), LCTL(KC_Z),         KC_TAB  , KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U , KC_I, KC_O, KC_P, KC_LBRC , KC_RBRC , TD(BSLS_PIPE) ,            KC_END, \
    LALT(S(KC_TAB)), LALT(KC_TAB), LCTL_T(KC_ESC), KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J , KC_K, KC_L,  KC_SCLN, KC_QUOT   , KC_ENTER, KC_ENTER,       KC_PGUP, \
    LCTL(S(KC_TAB)), LCTL(KC_TAB), KC_LSPO , KC_LSPO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N , KC_M   , KC_COMM, KC_DOT , KC_SLSH   , KC_RSPC , KC_UP ,       KC_PGDN, \
